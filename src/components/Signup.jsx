...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://dev-tinder-ggrn.onrender.com/sentotp",
        {
          emailId,
        }
      );
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      ...
      if (res1.data?.message) {
        ...
        dispatch(addUser(res2.data?.data));
  ...
  return (
    <div className="w-full flex justify-center h-screen py-14 ">
      <div className="card bg-base-300 w-96 shadow-sm h-fit mx-4 relative">
        <div className={`absolute ${popOtp ? "flex mt-10" : "hidden"}`}>
        ...
        <div className={`${popOtp ? "hidden" : "flex"}`}>
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <fieldset className="fieldset">
                ...
                <p className="w-fit text-rose-500 mt-1">{message}</p>
              </fieldset>
